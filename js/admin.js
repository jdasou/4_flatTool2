...
$(document).ready(function()
{
  ...
  if (apercu_field.length) {
    apercu_field.change(function () {
      ...
      let is_image = this.files[0].name.match(/.*\.(jpg|jpeg|gif|png|jfif)$/ig) != null;
      reader.onload = function(e) {
        if (t.next('.preview-img').length) {
          ...
          let img = $('<img/>').addClass('preview-img')
...
YSeditorObject.prototype = {
  ...
  options: function (node) {
    var t = this;
    var opts = ['justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull', 'bold', 'italic', 'underline', 'strikethrough', 'insertUnorderedList', 'textList', 'paint', 'link', 'seeMore', 'reset', 'code'];
